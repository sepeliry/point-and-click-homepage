...
export function playerCollides(player, solidObjects) {
    ...
    for (const object of solidObjects) {
        ...
        const collisionY =
            (playerBounds.y < footprintTop && playerBounds.y + playerBounds.height >= footprintTop - 20)
            || (playerBounds.y > footprintTop && playerBounds.y + playerBounds.height <= footprintBottom + 20);
