...
class Item {
   ...
   * @param {number} x - Percentage relative to app width, where the object is placed in the application
   * @param {number} y - Percentage relative to app height, where the object is placed in the application
