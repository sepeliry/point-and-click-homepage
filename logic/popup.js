...
class Popup {
  ...
  constructor(app) {
    ...
    this.text = new Text("Pelikehittäjän ohjeet", this.style);
    this.text.anchor.set(0.5);
    this.text.x = this.popupWidth / 2;
    this.text.y = this.popupHeight / 2;

    // Create Clickable URL
    this.urlText = new Text("Avaa ohjeet", this.urlStyle);
  ...
  openUrl(event) {
    window.open("https://sepeliry.github.io/unity1.html", "_blank");
